...
describe("Invalid", function () {
	...
	it("GET / (416 / 'Partial response - invalid #2')", function () {
		return httptest({url: "http://localhost:" + port + "/", headers: {range: "5-0"}})
			.expectStatus(416)
			.expectValue("error", http.STATUS_CODES[416])
			.end();
	});
	...
	it("GET /nothere.html (404 / 'Not Found')", function () {
		return httptest({url: "http://localhost:" + port + "/nothere.html"})
			.expectStatus(404)
			.expectHeader("allow", "")
	...
	it("GET /nothere.html%3fa=b?=c (404 / 'Not Found')", function () {
		return httptest({url: "http://localhost:" + port + "/nothere.html%3fa=b?=c"})
			.expectStatus(404)
			.expectHeader("allow", "")
			.expectValue("error", http.STATUS_CODES[404])
			.end();
	...
	it("GET /nothere.x_%22%3E%3Cimg%20src=x%20onerror=prompt(1)%3E.html (404 / 'Not Found')", function () {
		return httptest({url: "http://localhost:" + port + "/nothere.x_%22%3E%3Cimg%20src=x%20onerror=prompt(1)%3E.html"})
			.expectStatus(404)
			.expectHeader("allow", "")
			.expectValue("error", http.STATUS_CODES[404])
			.end();
	...
	it("POST /nothere.html (404 / 'Not Found')", function () {
		return httptest({url: "http://localhost:" + port + "/nothere.html", method: "post"})
			.expectStatus(404)
			.expectHeader("allow", "")
			.expectValue("error", http.STATUS_CODES[404])
			.end();
	...
	it("PUT /nothere.html (404 / 'Not Found')", function () {
		return httptest({url: "http://localhost:" + port + "/nothere.html", method: "put"})
			.expectStatus(404)
			.expectHeader("allow", "")
			.expectValue("error", http.STATUS_CODES[404])
			.end();
	...
	it("PATCH /nothere.html (404 / 'Not Found')", function () {
		return httptest({url: "http://localhost:" + port + "/nothere.html", method: "patch"})
			.expectStatus(404)
			.expectHeader("allow", "")
			.expectValue("error", http.STATUS_CODES[404])
			.end();
	...
	it("DELETE /nothere.html (404 / 'Not Found')", function () {
		return httptest({url: "http://localhost:" + port + "/nothere.html", method: "delete"})
			.expectStatus(404)
			.expectHeader("allow", "")
			.expectValue("error", http.STATUS_CODES[404])
			.end();
	...
	it("GET /../README (404 / 'Not Found')", function () {
		return httptest({url: "http://localhost:" + port + "/../README"})
			.expectStatus(404)
			.expectHeader("allow", "")
			.expectValue("error", http.STATUS_CODES[404])
			.end();
