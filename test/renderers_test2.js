...
describe("Renderers (HTTP2)", function () {
	...
	it("GET CSV (header)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port, headers: {accept: "text/csv"}})
			.expectStatus(200)
	...
	it("GET CSV (query string)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/?format=text/csv"})
			.expectStatus(200)
			.expectHeader("content-type", "text/csv")
			.expectHeader("content-disposition", "attachment; filename=\"download.csv\"")
			.expectBody(arg => csv.decode(arg) instanceof Object)
	...
	it("GET CSV (invalid)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/abc/?format=text/csv"})
			.expectStatus(404)
			.end();
	});
	...
	it("GET JSONP (query string)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/?format=application/javascript"})
			.expectStatus(200)
			.expectHeader("content-type", "application/javascript")
			.expectBody(/^callback\(/)
			.end();
	...
	it("GET JSONP (invalid)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/abc/?format=application/javascript"})
			.expectStatus(404)
			.end();
	});
	...
	it("GET HTML (query string)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/things?format=text/html"})
			.expectStatus(200)
			.expectHeader("content-type", /text\/html/)
	...
	it("GET HTML (invalid)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/abc/?format=text/html"})
			.expectStatus(404)
			.end();
	});

	it("GET YAML (header)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port, headers: {accept: "application/yaml"}})
			.expectStatus(200)
	...
	it("GET YAML (query string)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/?format=application/yaml"})
			.expectStatus(200)
			.expectHeader("content-type", "application/yaml")
			.end();
	});
	...
	it("GET YAML (invalid)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/abc/?format=application/yaml"})
			.expectStatus(404)
			.end();
	});

	it("GET XML (header)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port, headers: {accept: "application/xml"}})
			.expectStatus(200)
	...
	it("GET XML (query string)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/?format=application/xml"})
			.expectStatus(200)
			.expectHeader("content-type", "application/xml")
			.end();
	});
	...
	it("GET XML (invalid)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/abc/?format=application/xml"})
			.expectStatus(404)
			.end();
	});

	it("GET Custom (header)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port, headers: {accept: "application/custom"}})
			.expectStatus(200)
	...
	it("GET Custom (query string)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/?format=application/custom"})
			.expectStatus(200)
			.expectHeader("content-type", "application/json")
			.end();
	});
	...
	it("GET Custom (invalid)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/abc/?format=application/custom"})
			.expectStatus(404)
			.end();
	});

	it("GET Plain Text (header)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port, headers: {accept: "text/plain"}})
			.expectStatus(200)
			.expectHeader("content-type", "application/json")
			.end();
	});
	...
	it("GET Plain Text (query string)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/?format=text/plain"})
			.expectStatus(200)
			.expectHeader("content-type", "application/json")
			.end();
	});
	...
	it("GET Plain Text (invalid)", function () {
		return tinyhttptest({http2: true, url: "https://localhost:" + port + "/abc/?format=text/plain"})
			.expectStatus(404)
			.end();
	});
});
